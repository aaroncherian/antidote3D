...
class ReconstructedDataHolder:
    ...
    def reconstruct_new_3d_data(self, start_frame=None, end_frame=None):
        ...
        new_3d_data, repro_error = process_2d_data_to_3d(mediapipe_2d_data=self.joint_data_loader.joint_data[:,start_frame:end_frame,:,0:2], calibration_toml_path=self.calibration_toml_path, mediapipe_confidence_cutoff_threshold=.7)
